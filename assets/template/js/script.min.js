...
}), selectCarModel.addEventListener("focus", function () {
    document.querySelector(".form-order__car-model-wrap").classList.add("open")
}), selectCarModel.addEventListener("blur", function () {
    document.querySelector(".form-order__car-model-wrap").classList.remove("open")
}), selectCarModel.addEventListener("change", function () {
    document.querySelector(".form-order__car-model-wrap").classList.remove("open"), document.querySelector("#select-car-model").blur()
...
function setCost() {
    document.querySelector("#total-cost").innerHTML = Number(collectionCost()) + Number(additionallySum())
}
...
document.querySelector("#select-color .form-order__close").addEventListener("click", function () {
    ...
    }), document.querySelector("#select-collection .form-order__close").addEventListener("click", function () {
        document.querySelector("#select-collection").classList.contains("show") ? document.querySelector("#select-collection").classList.remove("show") : document.querySelector("#select-collection").classList.add("show")
