...
for (var radioBorderColor = document.querySelectorAll("input[name=borderColor]"), _i4 = 0; _i4 < radioBorderColor.length; _i4++) radioBorderColor[_i4].addEventListener("change", function () {
...
function setBorderColor(e) {
    ...
    switch (t.classList.remove("form-order__input--border-color--black"),t.classList.remove("form-order__input--border-color--orange"),t.classList.remove("form-order__input--border-color--green"),t.classList.remove("form-order__input--border-color--blackblue"), t.classList.remove("form-order__input--border-color--gray"), t.classList.remove("form-order__input--border-color--brown"), t.classList.remove("form-order__input--border-color--beige"), t.classList.remove("form-order__input--border-color--pink"), t.classList.remove("form-order__input--border-color--blue"), t.classList.remove("form-order__input--border-color--red"), t.classList.remove("form-order__input--border-color--yellow"), e) {
        ...
        case "серый":
            ...
            break;
        case "темносиний":
            t.classList.add("form-order__input--border-color--blackblue");
            break;
        case "оранжевый":
            t.classList.add("form-order__input--border-color--orange");
            break;
        case "коричневый":
...
function getCarModels(e) {
    $.ajax({
        ...
        data: {
            request:`carBrand=${e}`,
            url:"https://exzist.pro/assets/cars/getCarModels.php"
        },
        success: function (e) {
...
}), document.querySelector("#field-additionally-1").addEventListener("change", function () {
    this.checked ? document.querySelector("input[name=additionally-1-count]").removeAttribute("disabled") : document.querySelector("input[name=additionally-1-count]").setAttribute("disabled", !0)
}), document.querySelector("#field-additionally-2").addEventListener("change", function () {
    this.checked ? document.querySelector("input[name=additionally-2-count]").removeAttribute("disabled") : document.querySelector("input[name=additionally-2-count]").setAttribute("disabled", !0)
}), document.querySelector("#field-additionally-3").addEventListener("change", function () {
    this.checked ? document.querySelector("input[name=additionally-3-count]").removeAttribute("disabled") : document.querySelector("input[name=additionally-3-count]").setAttribute("disabled", !0)
}), document.querySelector("#field-additionally-4").addEventListener("change", function () {
    this.checked ? document.querySelector("input[name=additionally-4-count]").removeAttribute("disabled") : document.querySelector("input[name=additionally-4-count]").setAttribute("disabled", !0)
...
}), document.querySelector("#field-additionally-7").addEventListener("change", function () {
    this.checked ? document.querySelector("input[name=additionally-7-count]").removeAttribute("disabled") : document.querySelector("input[name=additionally-7-count]").setAttribute("disabled", !0)
})
for (var buttonPlus = document.querySelectorAll(".form-order__btn-num--plus"), buttonMinus = document.querySelectorAll(".form-order__btn-num--minus"), _i11 = 0; _i11 < buttonPlus.length; _i11++) buttonPlus[_i11].addEventListener("click", function () {
    ...
    this.parentNode.querySelector("input[type=number]").value = 0 < e ? ++e : 1,additionally1Sum(),additionally2Sum(),additionally3Sum(),additionally4Sum(), additionally5Sum(), additionally6Sum(),additionally7Sum(), setCost()
});
for (var _i12 = 0; _i12 < buttonMinus.length; _i12++) buttonMinus[_i12].addEventListener("click", function () {
    var e = this.parentNode.querySelector("input[type=number]").value;
    this.parentNode.querySelector("input[type=number]").value = 1 < e ? --e : 1,additionally1Sum(),additionally2Sum(),additionally3Sum(),additionally4Sum(), additionally5Sum(), additionally6Sum(),additionally7Sum(), setCost()
});
...
function additionally1Sum() {
    var e = document.querySelector("#field-additionally-1").getAttribute("data-price-one"),
        t = document.querySelector("input[name=additionally-1-count]").value;
    document.querySelector("#field-additionally-1").setAttribute("data-price", e * t)
}

function additionally2Sum() {
    var e = document.querySelector("#field-additionally-2").getAttribute("data-price-one"),
        t = document.querySelector("input[name=additionally-2-count]").value;
    document.querySelector("#field-additionally-2").setAttribute("data-price", e * t)
}

function additionally3Sum() {
    var e = document.querySelector("#field-additionally-3").getAttribute("data-price-one"),
        t = document.querySelector("input[name=additionally-3-count]").value;
    document.querySelector("#field-additionally-3").setAttribute("data-price", e * t)
}

function additionally4Sum() {
    var e = document.querySelector("#field-additionally-4").getAttribute("data-price-one"),
        t = document.querySelector("input[name=additionally-4-count]").value;
    document.querySelector("#field-additionally-4").setAttribute("data-price", e * t)
}
...
function additionally7Sum() {
    var e = document.querySelector("#field-additionally-7").getAttribute("data-price-one"),
        t = document.querySelector("input[name=additionally-7-count]").value;
    document.querySelector("#field-additionally-7").setAttribute("data-price", e * t)
}
